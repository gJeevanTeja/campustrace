                ...
                <div style={{
                    ...
                    <div style={{ 
                        ...
                        <div style={{
                            ...
                            boxShadow: '0 4px 6px -1px rgba(0,0,0,0.1)', marginBottom: -50, zIndex: 1
                        }}>
                            {college?.logo ? (
                    ...
                    <div style={{ padding: '70px 32px 32px' }}>
                        <h3 style={{ margin: '0 0 4px', fontSize: 24, fontWeight: 800 }}>{college?.name || 'N/A'}</h3>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 24 }}>
                            <div style={{ 
                                ...
                                <p style={{ margin: 0, fontSize: 18, fontWeight: 700 }}>{college?.email_domain || 'N/A'}</p>
                            </div>
                        ...
                        <div style={{ marginTop: 32, padding: 24, borderRadius: 20, background: '#2563eb08', border: '1px solid #2563eb22' }}>

        ...
        <div className="max-w-6xl mx-auto space-y-12 pb-32 px-4">
            ...
            <header className="flex flex-col md:flex-row md:items-center justify-between gap-6 pt-12">
                <div className="space-y-2">
                   <div className="flex items-center gap-4">
                       ...
                       <h1 className="text-4xl font-black text-text-primary uppercase tracking-tighter">My Claims</h1>
                   </div>
            ...
            {items.length === 0 ? (
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="py-24 text-center space-y-8">
                    ...
                    <div className="space-y-2">
                       <h3 className="text-2xl font-black text-text-primary uppercase tracking-tighter">Quiet Claims</h3>
                       <p className="max-w-xs mx-auto text-sm font-medium text-text-secondary leading-relaxed">No claims detected. If you've lost something, try searching the browse page.</p>
                    </div>
                    <button onClick={() => navigate('/browse')} className="px-10 py-5 bg-white border-2 border-primary/20 text-primary font-black uppercase tracking-widest text-xs rounded-3xl hover:bg-primary hover:text-white transition-all shadow-xl shadow-primary/5">
                        Browse Items
                    </button>
                </motion.div>
            ) : (
